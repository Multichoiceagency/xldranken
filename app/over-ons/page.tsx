...
export const metadata: Metadata = {
  title: "Over Ons | XL Groothandel",
  description:
    "Ontdek XL Groothandel, dé specialist in alcoholische en non-alcoholische dranken met meer dan 900 verschillende producten.",
}
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="relative z-20 container mx-auto px-4 py-24 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl mb-8 text-white">
              Welkom bij XL Groothandel, dé specialist in alcoholische en non-alcoholische dranken. Met trots bieden wij een
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <div className="mb-16">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-[#BEA46A]">XL Groothandel</h2>
            <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
              <div className="flex flex-col md:flex-row gap-8 items-center mb-8">
                <div className="md:w-1/2">
                  <h3 className="text-xl font-semibold mb-4">900+ DRANKEN & PRODUCTEN</h3>
                  <p className="text-gray-700 mb-4">
                    Welkom bij XL Groothandel, dé specialist in alcoholische en non-alcoholische dranken. Met trots bieden
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 text-center flex flex-col justify-between">
              <div>
