...
type FrisdrankenPageClientProps = {
  initialProducts: ProductProps[]
}

export default function FrisdrankenPageClient({ initialProducts }: FrisdrankenPageClientProps) {
  ...
  const createURL = (key: string, value: string | number) => {
    ...
    return `/Frisdranken?${params.toString()}`
  }
